              ...
              .then(res3=>{
                ...
                .then(res8=>{
                    ...
                    const NonActive = res8.filter((res9,i)=>{
                        ...
                        if(res9.status && res9.Type1 === "sale" ){
                          return res9 
                        }
                    })
    ...
    fetch("https://d-luxe-housebackend.vercel.app/AllProduct",{
                ...
                .then(res8=>{
                    ...
                    const NonActive = res8.filter((res9,i)=>{
                        ...
                        if(res9.status && res9.Type1 === CategoriesName.categoriesName ){
                          return res9 
                        }
                    })
                  ...
                  <div className="product-item-filter row">
                    <div className="col-12 col-sm-8 text-center text-sm-left">
                      <div className="toolbar-sorter-right">
                        <span>Sort by </span>
                        <select id="basic" className="selectpicker show-tick form-control" data-placeholder="$ USD" style={{width : "auto"}} onChange={(e)=>setSortPrice1(e.target.value)}>
                      ...
                      <p>Showing all {Subproduct.length} results</p>
                    </div>
                                  ...
                                  <div className="list-group">
                                  {
                                      subCate.map((res1,j)=>{
                                        if(res1.MainCategories === res.MainCategories){
                                          return (
                                            <a target='_blank' href={"/categories/"+res.MainCategories+"/all-products"} className="list-group-item list-group-item-action active">{res.CategoriesName}</a>
                                          )
                                        }
                                      })

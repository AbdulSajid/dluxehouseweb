...
export function SchoolBookProductDetail(props) {
        ...
        <div>
            <div className="bg-light py-3">
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 mb-0"><Link to="/">Home</Link> <span className="mx-2 mb-0">/</span> <strong className="text-black">Books</strong><span className="mx-2 mb-0">/</span> <strong className="text-black">{productDetail.Product_Name}</strong></div> 
                    </div>
                </div>
            </div>
            ...
            <div className="site-section">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-md-12" style={{width : "100%", margin  : "0px",padding: "0px"}} >
...
export default SchoolBookProductDetail;

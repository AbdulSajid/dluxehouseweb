                    ...
                    <div className="container-fuild" style={{margin : "70px auto" , width : "93%"}}>
                            <div className="row justify-content-center">
                                <div className="col-12 text-center">
                                    <h2 style={{color : "black"}} > <b>Books for School Kids</b> </h2>
                                    <br/>
                                    <h4 style={{color : "black"}} > Shop Text Books & Reference Books </h4>
                                    <center>
                                        <p style={{width : "320px" , border : "0.5px solid grey" }}></p>
                                    </center>
                                </div> 
                                <div className="arrival1" >
                                        <Link to="/categories/books/Al-bader"><img src={s1} alt="" className="arrival-Photo11"/></Link>
                                        </div>
                                        <div className="arrival1" >
                                        <Link to="/categories/books/badar"><img src={s2} alt="" className="arrival-Photo11"/></Link>
                                        </div>
                                        <div className="arrival1">
                                        <Link to="/categories/books/hhs"><img src={s3} alt="" className="arrival-Photo11"/></Link>
                                        </div>
                                        <div className="arrival1" >
                                        <Link to="/categories/books/iife"><img src={s4} alt="" className="arrival-Photo11"/></Link>
                                        </div>
                                        <div className="arrival1" >
                                        <Link to="/categories/books"><img src={par6} alt="" className="arrival-Photo11"/></Link>
                                        </div>
                                        <div className="arrival1">

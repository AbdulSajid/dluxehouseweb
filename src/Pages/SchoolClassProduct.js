...
const SchoolClassProduct = (props)=> {
            ...
            <div>
                ...
                <div className="bg-light py-3">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12 mb-0"><Link to="/">Home</Link> <span className="mx-2 mb-0">/</span> <strong className="text-black">Shop</strong> <span className="mx-2 mb-0">/</span><strong>Products</strong> </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        return(
                                            <div className="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                                <div className="block-4 text-center border">
                                                    ...
                                                    <Link to='/detail'>
                                                    <img src={res.Product_Image_Upload}  style={{height : "210px" , width : "200px" }}  alt="Image placeholder" className="img-fluid" />
                                                    </Link>
                                                    </figure>
                                                    <div className="block-4-text p-4">
                                                        ...
                                                        <Link to="/categories/books/Al-badar/123"    onClick={()=>savethedetailproduct(res)}><div className="btn btn-sm btn-primary">View</div></Link>
                            ...
                            <div className="col-md-3 order-1 mb-5 mb-md-0">
                                ...
                                <div className="border p-4 rounded mb-4">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input type="checkbox" name="" id=""/> Low to High <br/>
                                        <input type="checkbox" name="" id=""/> A to Z <br/>
                                    ...
                                    <hr/>
                                    <div className="mb-4">
                                        <h3 className="mb-3 h5 text-uppercase text-black d-block">Color</h3>
                                        <input type="checkbox" name="" id=""/> Black <br/>
                                        <input type="checkbox" name="" id=""/> White <br/>
                                        {/* <div id="slider-range" className="border-primary"></div> */}
                                        {/* <button  className="btn btn-sm btn-primary" onClick={()=>SortData1("A","Z")}> Low to High</button> */}
                                    </div>
                                    {/* <div className="mb-4">
                                        <h3 className="mb-3 h5 text-uppercase text-black d-block">Type</h3>
                                        <input type="checkbox" name="" id=""/> Low to High <br/>
                                        <input type="checkbox" name="" id=""/> A to Z <br/>
                                    </div> */}
                                    <hr/>
...
export default SchoolClassProduct;

        ...
        swal("Enter The Password !"  )
         ...
         if(phone.length !== 13){
          swal("Enter The Phone Number !"  )
           ...
           fetch("https://database-student-1-stop.herokuapp.com/main-signup-user-check",{
            method: 'POST' , 
            headers :  {
  ...
  return (
    ...
    { gy ?
       <div className="container-fuild rgjrgou" style={{width : "30%" , margin : "50px auto",padding: "40px 41px",boxShadow: "0px 2px 6px red"}}>
            ...
            <br/>
                    <button  onClick={()=>postData()} className="btn btn-primary btn-block" style={{width: "90%",margin: "auto",background : "rgb(227, 77, 92)" , border : "1px solid rgb(227, 77, 92)"}}>Sign Up</button>

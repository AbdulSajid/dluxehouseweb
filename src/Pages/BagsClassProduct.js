            ...
            <div>
                ...
                <div className="bg-light py-3">
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12 mb-0"><Link to="/">Home</Link> <span className="mx-2 mb-0">/</span> <strong className="text-black">Shop</strong> <span className="mx-2 mb-0">/</span><strong>Bag Products</strong> </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div className="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                                                <div className="block-4 text-center border">
                                                    ...
                                                    <div className="block-4-text p-4">
                                                        ...
                                                        <Link to="/categories/bags/product/123"    onClick={()=>savethedetailproduct(res)}><div className="btn btn-sm btn-primary">View</div></Link>
...
export default BagsClassProduct;

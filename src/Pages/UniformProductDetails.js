...
export function UniformProductDetails(props) {
...
const  changePhoto = ()=>{
    document.getElementById("changes-Photo").src = u2
}
        ...
        <div>
            <div className="bg-light py-3">
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 mb-0"><Link to="/">Home</Link> <span className="mx-2 mb-0">/</span> <strong className="text-black">Uniform</strong><span className="mx-2 mb-0">/</span> <strong className="text-black">{productDetail.Product_Name}</strong></div> 
                    </div>
                </div>
            </div>
...
export default UniformProductDetails;
